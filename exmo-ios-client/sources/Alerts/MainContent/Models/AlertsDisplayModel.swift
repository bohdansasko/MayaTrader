...
class AlertsDisplayModel {
    ...
    func update() {
        alertsItems = [
            ...
            AlertItem(currencyPairName: "ETH/USD", currencyPairPriceAtCreateMoment: 1165, note: "Good chance for make money", topBoundary: 1490, bottomBoundary: 1100, status: .Pause, dateCreated: Date()),
