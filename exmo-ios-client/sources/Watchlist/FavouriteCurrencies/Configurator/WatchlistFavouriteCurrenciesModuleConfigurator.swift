...
class WatchlistFavouriteCurrenciesModuleConfigurator {
    ...
    private func configure(viewController: WatchlistFavouriteCurrenciesViewController) {
        ...
        viewController.datasource = WatchlistFavouriteDataSource(items: getTestData())
    }

    fileprivate func getTestData() -> [WatchlistCurrencyModel] {
        return [
            WatchlistCurrencyModel(pairName: "ETH_LTC", buyPrice: 3.82002126, timeUpdataInSecFrom1970: 1539544686, closeBuyPrice: 3.72920000, volume: 344.89666572, volumeCurrency: 1320.80049895),
            ...
            WatchlistCurrencyModel(pairName: "BTC_USD", buyPrice: 0.46100233, timeUpdataInSecFrom1970: 1539544686, closeBuyPrice: 0.41792313, volume: 4068944.53664728, volumeCurrency: 1876597.22030172),
