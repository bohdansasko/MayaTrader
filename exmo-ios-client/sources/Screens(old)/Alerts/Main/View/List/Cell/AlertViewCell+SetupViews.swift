...
extension AlertViewCell {    
    func setupLeftViews() {
        ...
        labelTimeCreate.anchor(self.topAnchor,
        ...
        labelAlertStatus.anchor(labelTimeCreate.bottomAnchor,
                                left: self.leftAnchor,
                                bottom: nil,
                                right: nil,
                                topConstant: 5,
    ...
    func setupRightViews() {
        ...
        contentView.anchor(imageSeparator.topAnchor,
                           left: imageSeparator.rightAnchor,
                           bottom: imageSeparator.bottomAnchor,
        ...
        leftColumnStackView.anchor(contentView.topAnchor,
                                   left: contentView.leftAnchor,
                                   bottom: contentView.bottomAnchor,
                                   right: nil,
                                   topConstant: topOffset,
                                   leftConstant: 0,
                                   bottomConstant: 0,
                                   rightConstant: 0,
                                   widthConstant: 80,
        ...
        rightColumnStackView.anchor(contentView.topAnchor,
                                    left: nil,
                                    bottom: contentView.bottomAnchor,
